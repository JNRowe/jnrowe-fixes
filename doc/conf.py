# -*- coding: utf-8 -*-
#
# jnrowe-fixes documentation build configuration file, created by
...
htmlhelp_basename = 'jnrowe-fixesdoc'
...
latex_documents = [
  ('index', 'jnrowe-fixes.tex', u'jnrowe-fixes Documentation',
   u'James Rowe', 'manual'),
]
...
man_pages = [
    ('index', 'jnrowe-fixes', u'jnrowe-fixes Documentation',
     [u'James Rowe'], 1)
]
